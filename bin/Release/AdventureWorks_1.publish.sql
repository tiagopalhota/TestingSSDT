...
GO
PRINT N'Creating unnamed constraint on [dbo].[__MigrationLog]...';


GO
ALTER TABLE [dbo].[__MigrationLog]
    ADD DEFAULT 0 FOR [WasSuccessful];


GO
PRINT N'Creating [dbo].[sp_execute_script]...';
